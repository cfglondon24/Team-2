...
questions = {
    ...
    "Sepsis is less fatal than cancer.": [
        False,
        "Sepsis kills more than breast, bowel and prostate cancer combined Bowel: 16,300 Breast:11,400 Prostate: 11,700 .Meaning sepsis kills over 39,400 people",
...
for question in questions:
    cur.execute(
        "INSERT INTO flashcards (question, answer, extra_info) VALUES (?, ?, ?)",
        (question, questions[question][0], questions[question][1]),
    )
